...
class UserFollowerTabFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        database = FirebaseDatabase.getInstance().getReference("users").child(auth.uid.toString()).child("followers")
...
//
        ...
        allDbUser.addValueEventListener(object : ValueEventListener{
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                view.followerListView.adapter = ListFollowAdapter(view.context, R.layout.list_follower, allUserList)
            }
        })
